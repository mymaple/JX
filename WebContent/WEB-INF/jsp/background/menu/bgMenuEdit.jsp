...
<html lang="en">
	...
	<body>
		<form action="background/menu/editMenu.do" name="menuForm" id="menuForm" method="post">
			...
			<table>
				<tr>
					<td>
						<select name="parentId" id="parentId" onchange="selectParentId()" title="菜单">
				...
				<td style="text-align: center; padding-top: 10px;">
					<a class="btn btn-mini btn-primary" onclick="editMenu();">保存</a>
