...
<body>
	<form  action="background/menu/addMenu.do" name="menuForm" id="menuForm" method="post" >
		...
		<table>
			<tr>
				<td>
					<select name="parentId" id="parentId" class="input_txt" onchange="selectParentId()"  title="菜单">
			...
			<tr>
				<td style="text-align: center;">
					<label style="float:left;padding-left: 32px;"><input name="form-field-radio" id="form-field-radio1" onclick="selectMenuType('1');" type="radio" value="icon-edit"><span class="lbl">系统菜单</span></label>
					<label style="float:left;padding-left: 5px;"><input name="form-field-radio" id="form-field-radio2" onclick="selectMenuType('2');" type="radio" value="icon-edit"><span class="lbl">业务菜单</span></label>
				</td>
			</tr>
			<tr>
